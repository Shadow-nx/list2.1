...
void fill_list(int numbers_array[],int numbers_count,Node **firstt,Node **last) {
	for(int i=0; i<numbers_count; i++) {
...
void addlist(Node **first,Node **last) {
	...
	check_numbers(c_str,numbers_array,&numbers_count);
